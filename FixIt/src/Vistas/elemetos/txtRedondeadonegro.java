...
public class txtRedondeadonegro extends JTextField { // Clase pública

    public txtRedondeadonegro() {
        super();
        try {
            // Configuración inicial del JTextField
            setOpaque(false); // Hace el JTextField transparente
            setForeground(Color.BLACK); // Texto color negro
            ...
            setBorder(new RoundedBorder(new Color(0x000000), 2, 15)); // Color #FFC300 con borde redondeado
